...
Для задания основных параметров перекрёстка написана форма ввода данных на html+javascript,
на той же странице реализовано отображение результатов моделирования в виде условных 
изображений автомобилей, перемещающихся по перекрёстку.
